...
This plugin embeds the content of a facebook page directly into a wordpress post.
...
1. Download wp embed facebook plugin from [Wordpress](http://wordpress.org/) or from the plugin [website](http://saliuitl.org/wp-embed-facebook)
